    ...
    {
        "Monitor" {      #监视器
            $IDF_RUN = "idf.py monitor -b $MONITOR_BAUD -p $MONITOR_COM";
            break
        }
        "Flash" {      #下载
            $IDF_RUN = "idf.py flash -b $FLASH_BAUD -p $FLASH_COM";
            break
        }
        "Menuconfig" {      #配置菜单
        ...
        "FM" {      #下载并打开监视器
            $IDF_RUN = "idf.py flash -b $FLASH_BAUD -p $FLASH_COM monitor -b $MONITOR_BAUD -p $MONITOR_COM";
            break
        }
        "FC" {      #Full Clean
        ...
        "S3" {      #设置target为S3
            $IDF_RUN = "idf.py set-target esp32s3"
            break
        }
        "C3" {      #设置target为C3
            $IDF_RUN = "idf.py set-target esp32c3"
            break
        }
        Default {      #无参数
            $IDF_RUN = "No Parameter"
        }
    }
